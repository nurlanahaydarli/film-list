let film_box = document.getElementById("film_list")
...
let film_data = film_list.map((film) => {
    return `
    <div class="col-lg-6">
    <div class="card mb-3 w-100">
      <div class="row no-gutters">
        ...
        <div class="col-lg-12">
        <div class="card-body">
            <p class="card-text"><small class="text-muted">Released: ${film['Released']}</small></p>
            <p class="card-text"><small class="text-muted">Runtime: ${film['Runtime']}</small></p>
            <p class="card-text"><small class="text-muted">Genre: ${film['Genre']}</small></p>
            <p class="card-text"><small class="text-muted">Director: ${film['Director']}</small></p>
            <p class="card-text"><small class="text-muted">Writer: ${film['Writer']}</small></p>
            <p class="card-text"><small class="text-muted">Country: ${film['Country']}</small></p>
            <p class="card-text"><small class="text-muted">Language: ${film['Language']}</small></p>
           </div>
        </div>
      </div>
    </div>
